...
START_TEST(test_sub_simple1) {
  mo_decimal decimal1 = {{0x5, 0, 0, 0}};
  mo_decimal decimal2 = {{0x8, 0, 0, 0}};
  mo_decimal result;
  mo_sub(decimal1, decimal2, &result);

  ck_assert_str_eq(decimal_to_string(result), "-3");
}
END_TEST

START_TEST(test_sub_simple2) {
...
START_TEST(test_sub_simple_neg1) {
  int simple_decimal1 = -775604;
...
START_TEST(test_sub_simple_neg2) {
  int simple_decimal1 = -775604;
  int simple_decimal2 = -56578;
  int simple_decimal1_neg = simple_decimal1 * -1;
...
START_TEST(test_sub_simple_neg3) {
  int simple_decimal1 = 775604;
  int simple_decimal2 = -56578;
  int simple_decimal2_neg = simple_decimal2 * -1;
  int res = simple_decimal1 - simple_decimal2;
...
START_TEST(test_sub_simple_check_code1) {
  mo_decimal decimal1 = {{0x5, 0, 0, 0}};
  mo_decimal decimal2 = {{0x8, 0, 0, 0}};
  mo_decimal result;
  int code = mo_sub(decimal1, decimal2, &result);

  ck_assert_int_eq(code, 0);
}
END_TEST

START_TEST(test_sub_simple_check_code2) {
...
START_TEST(test_sub_simple_check_code3) {
...
START_TEST(test_sub_simple_check_code4) {
...
START_TEST(test_sub_simple_check_code5) {
...
START_TEST(test_sub_simple_check_code6) {
  mo_decimal decimal1 = {{0, 0, 0, 0}};
...
START_TEST(test_sub_simple_check_code7) {
...
START_TEST(test_sub_simple_float_equal_small_pow1) {
...
START_TEST(test_sub_simple_float_equal_small_pow2) {
...
START_TEST(test_sub_simple_float_equal_small_pow3) {
  double simple_decimal1 = 0.56;
...
START_TEST(test_sub_simple_float_equal_small_pow4) {
...
START_TEST(test_sub_simple_float_neg_equal_small_pow1) {
  double simple_decimal1 = -549879.55;
  double simple_decimal2 = 0.12;
  double res = simple_decimal1 - simple_decimal2;
  char res_to_str[50];
...
START_TEST(test_sub_simple_float_neg_equal_small_pow2) {
  double simple_decimal1 = 549879.55;
  double simple_decimal2 = -0.12;
  double res = simple_decimal1 - simple_decimal2;
  char res_to_str[50];
...
START_TEST(test_sub_simple_float_neg_equal_small_pow3) {
  double simple_decimal1 = -549879.55;
  double simple_decimal2 = -0.12;
  double res = simple_decimal1 - simple_decimal2;
  char res_to_str[50];
...
START_TEST(test_sub_simple_float_diff_small_pow1) {
...
START_TEST(test_sub_simple_float_diff_small_pow2) {
  double simple_decimal1 = 78.569874;
...
START_TEST(test_sub_simple_float_neg_diff_small_pow1) {
  double simple_decimal1 = -78.569874;
  double simple_decimal2 = 9.48224568;
  double res = simple_decimal1 - simple_decimal2;
  char res_to_str[50];
...
START_TEST(test_error_result_is_null) {
  ...
  int code = mo_sub(decimal1, decimal2, NULL);
...
Suite *suite_sub(void) {
  ...
  tcase_add_test(tc, test_sub_simple1);
  tcase_add_test(tc, test_sub_simple2);
  tcase_add_test(tc, test_sub_simple3);
  tcase_add_test(tc, test_sub_simple4);
  tcase_add_test(tc, test_sub_simple5);
  tcase_add_test(tc, test_sub_simple_neg1);
  tcase_add_test(tc, test_sub_simple_neg2);
  tcase_add_test(tc, test_sub_simple_neg3);
  tcase_add_test(tc, test_sub_simple_check_code1);
  tcase_add_test(tc, test_sub_simple_check_code2);
  tcase_add_test(tc, test_sub_simple_check_code3);
  tcase_add_test(tc, test_sub_simple_check_code4);
  tcase_add_test(tc, test_sub_simple_check_code5);
  tcase_add_test(tc, test_sub_simple_check_code6);
  tcase_add_test(tc, test_sub_simple_check_code7);
  tcase_add_test(tc, test_sub_simple_float_equal_small_pow1);
  tcase_add_test(tc, test_sub_simple_float_equal_small_pow2);
  tcase_add_test(tc, test_sub_simple_float_equal_small_pow3);
  tcase_add_test(tc, test_sub_simple_float_equal_small_pow4);
  tcase_add_test(tc, test_sub_simple_float_neg_equal_small_pow1);
  tcase_add_test(tc, test_sub_simple_float_neg_equal_small_pow2);
  tcase_add_test(tc, test_sub_simple_float_neg_equal_small_pow3);
  tcase_add_test(tc, test_sub_simple_float_diff_small_pow1);
  tcase_add_test(tc, test_sub_simple_float_diff_small_pow2);
  tcase_add_test(tc, test_sub_simple_float_neg_diff_small_pow1);
  tcase_add_test(tc, test_sub_decimal1);
  tcase_add_test(tc, test_sub_decimal2);
  tcase_add_test(tc, test_sub_decimal3);
