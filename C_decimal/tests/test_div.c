...
START_TEST(test_div_simple1) {
  mo_decimal decimal1 = {{0x8, 0, 0, 0}};
  mo_decimal decimal2 = {{0x4, 0, 0, 0}};
  mo_decimal result;
  mo_div(decimal1, decimal2, &result);

  ck_assert_str_eq(decimal_to_string(result), "2");
}
END_TEST

START_TEST(test_div_simple2) {
  double simple_decimal1 = 98807;
  double simple_decimal2 = 580;
  char res_to_str[50] = "170.35689655172413793103448276";
...
START_TEST(test_div_simple3) {
  double simple_decimal1 = 5879;
  double simple_decimal2 = 988;
  char res_to_str[50] = "5.9504048582995951417004048583";
...
START_TEST(test_div_simple4) {
  double simple_decimal1 = 0;
  double simple_decimal2 = 654498797;
  double res = simple_decimal1 / simple_decimal2;
  char res_to_str[50];
  sprintf(res_to_str, "%.0f", res);
...
END_TEST
 ...
 START_TEST(test_div_simple5) {
     double  simple_decimal1 = 775604;
     double  simple_decimal2 = 0;
     double  res = simple_decimal1 / simple_decimal2;
   char res_to_str[50];
   ...
   mo_decimal decimal2 = {{simple_decimal2, 0, 0, 0}};
   mo_decimal result;
   int code = mo_div(decimal1, decimal2, &result);
...
START_TEST(test_error_result_is_null) {
  ...
  int code = mo_div(decimal1, decimal2, NULL);
...
Suite *suite_div(void) {
  ...
  tcase_add_test(tc, test_div_simple1);
  tcase_add_test(tc, test_div_simple2);
  tcase_add_test(tc, test_div_simple3);
  tcase_add_test(tc, test_div_simple4);
  tcase_add_test(tc, test_div_simple5);
